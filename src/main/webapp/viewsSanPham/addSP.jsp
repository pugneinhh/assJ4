    ...
    <div class="row" style="border: 1px darkgrey solid; border-radius: 10px;width: 50%; margin: 0 auto; padding: 20px;">
        <div class="col-sm-12">
            <form action="/addSP" method="post" >
                <h1 class="mt-5 mb-5 text-center">Thêm Sản Phẩm</h1>
                <div class="form-group">
                    <h3 class="mb-2">Mã Sản Phẩm:</h3>
                    <input type="text" class="form-control" name="ma" placeholder="Enter Ma San Pham">
                    <p style="color:red;">${LOI_MA}</p>
                </div>
                <div class="form-group">
                    <h3 class="mb-2">Tên Sản Phẩm:</h3>
                    <input type="text" class="form-control" name="ten"  placeholder="Enter Ten San Pham">
